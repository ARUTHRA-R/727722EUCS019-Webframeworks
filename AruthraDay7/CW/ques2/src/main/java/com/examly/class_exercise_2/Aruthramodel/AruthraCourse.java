...
public class AruthraCourse {
     ...
     public AruthraCourse() {

     }

     public AruthraCourse(int courseId, String courseName, int creditHours, String instructor, String preRequistes,
