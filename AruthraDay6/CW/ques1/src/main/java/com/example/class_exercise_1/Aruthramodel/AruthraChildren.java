package com.example.class_exercise_1.Aruthramodel;

import jakarta.persistence.Entity;
import jakarta.persistence.Id;

@Entity
public class AruthraChildren {
     @Id
     private int babyId;
     ...
     public AruthraChildren() {

     }

     public AruthraChildren(int babyId, String babyFirstName, String babyLastName, String fatherName, String motherName,
               String address) {
          this.babyId = babyId;
